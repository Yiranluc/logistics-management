class InventoryItemsController < ApplicationController
  ...
  def create
    ...
    @inventory_item.locations_id = params[:locations_id]
  ...
  private
    ...
    def inventory_item_params
      params.require(:inventory_item).permit(:name, :upc_code, :quantity, :category,
                                             :status, :date_of_arrival, :description, :locations_id)
    end
end
